...
class AlertsScreenseller extends StatefulWidget {
  const AlertsScreenseller({Key? key}) : super(key: key);

  @override
  State<AlertsScreenseller> createState() => _AlertsScreensellerState();
}

class _AlertsScreensellerState extends State<AlertsScreenseller> {
  @override
