...
class DashBoardseller extends StatefulWidget {
  const DashBoardseller({Key? key}) : super(key: key);
...
class _DashBoardsellerState extends State<DashBoardseller> {
  ...
  Widget getFragment() {
    if (selectedIndex == 0) {
      ...
      return const AlertsScreenseller();
    } else if (selectedIndex == 2) {
      return const JobsScreenseller();
    } else if (selectedIndex == 3) {
      return const BookmarkScreenseller();
    } else if (selectedIndex == 4) {
      return const AddWorkPageseller();
    }
    return const HomeScreenseller();
  }
