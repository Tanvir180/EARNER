...
//                         children: [
//                           Text(
//                             jobslist[index]['companyname'].toString(),
//                             style: const TextStyle(
//                               fontSize: 15,
//                               color: Colors.black,
//                             ),
...
//                           ),
//                           Text(
//                             jobslist[index]['location'].toString(),
//                             style: const TextStyle(
//                               fontSize: 15,
//                             ),
//                           ),
...
//                             children: [
//                               Text(
//                                 jobslist[index]['Duration'].toString(),
//                                 style: const TextStyle(
//                                   fontSize: 15,
//                                 ),
//                               ),
...
//                               ),
//                               Text(
//                                 jobslist[index]['applications'].toString(),
//                                 style: const TextStyle(
//                                   fontSize: 15,
//                                   color: AppColors.deeppurple,
//                                 ),
...
//                         child: Image(
//                           image: AssetImage(
//                             jobslist[index]['avatar'].toString(),
//                           ),
//                         ),
//                       ),
//                       trailing: Container(
